...
public class UtilizationModelDellWorkload implements UtilizationModel{
	 ...
	 */
	public UtilizationModelDellWorkload(String inputPath, double schedulingInterval)
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public UtilizationModelDellWorkload(String inputPath, double schedulingInterval, int dataSamples)
			throws NumberFormatException,
			IOException {
		setSchedulingInterval(schedulingInterval);
